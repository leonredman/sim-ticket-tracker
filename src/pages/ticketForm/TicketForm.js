              ...
              <div className="ui form">
                <div className="fields">
                  ...
                  <div className="six wide field">
                    ...
                    >
                      ...
                      <option value="Ready">Build In Progress</option>
                      <option value="Ready">Build Complete</option>
                      <option value="Ready">QA In Progress</option>
                      <option value="Ready">QA Complete</option>
                    </select>
                  </div>
                </div>
                ...
                <div className="fields">
                  <div className="six wide field">
                    ...
                    >
                      <option value="">Select</option>
                      <option value="Unassinged">Unassigned</option>
                ...
                <div className="fields">
                  <div className="six wide field">
                    ...
                    >
                      <option value="">Select</option>
                      <option value="Unassinged">Unassinged </option>
                      <option value="Mark Hamill">Mark Hamill</option>
                      <option value="Harrision Ford">Harrision Ford</option>
                ...
                <div className="fields">
                  <div className="six wide field">
                    ...
                    >
                      <option value="">Select</option>
                      <option value="Padame Amidala">Padame Amadala</option>
                      <option value="Breha Organa">Breha Organa</option>
                      <option value="Ahsoka Tano">Asoka Tano</option>
                    </select>
                  </div>
                </div>
